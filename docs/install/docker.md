...
AMD64
```bash
docker pull moqisoft/documentserver:9.2.0-amd64
```
ARM64
```bash
docker pull moqisoft/documentserver:9.2.0-arm64
```

#### 阿里云
AMD64
```bash
docker pull crpi-jfv3ro7j3i1a1bjk.cn-shanghai.personal.cr.aliyuncs.com/moqisoft/documentserver:9.2.0-amd64
```

ARM64
```bash
docker pull crpi-jfv3ro7j3i1a1bjk.cn-shanghai.personal.cr.aliyuncs.com/moqisoft/documentserver:9.2.0-arm64
```     
...
docker run -itd \    
    ...
    moqisoft/documentserver:9.2.0-amd64
```
