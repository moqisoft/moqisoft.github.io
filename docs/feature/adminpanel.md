---
description: onlyoffice中国版管理面板adminpanel功能介绍，提供图形化配置界面，支持9.1.01+版本，简化配置文件编辑工作。
---

# 管理面板 <span class="ant-tag">9.1.01+支持</span>

> [!TIP]  
> 该功能官方社区版自 9.3.0 已经移除，不再提供。中国版依然保留了最后的版本，可放心使用。
...
```bash
AdminPanel SETUP REQUIRED | Bootstrap code: IK6HKVU0YMB3 | Expires: 2025-11-01T14:00:00.000Z | Open: http://host/adminpanel
```
